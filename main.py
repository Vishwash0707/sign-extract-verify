    ...
    while True:
        ...
        if k % 256 == 27:
            ...
            if not os.path.isdir('temp'):
                os.mkdir('temp', mode=0o777)  # to make sure the directory exists
...
def checkSimilarity(window, path1, path2):
    ...
    if result == True:
        messagebox.showinfo("Success:","Signature is vaild!!")
    else:
        messagebox.showerror("Failure:","Signature is valid!!")
